...
public class BasePageElement implements WebElement {

  private static final Logger LOGGER = Logger.getLogger(BasePageElement.class);
  private WebElement webElement;
  private String name;

  public BasePageElement(WebElement webElement) {
  ...
  public BasePageElement waitUntilVisible() {
